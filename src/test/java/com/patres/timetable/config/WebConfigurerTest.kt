...
class WebConfigurerTest {
    ...
    fun testStartUpProdServletContext() {
        ...
        verify<MockServletContext>(servletContext).addFilter(eq("webappMetricsFilter"), any(InstrumentedFilter::class.java))
        verify<MockServletContext>(servletContext).addServlet(eq("metricsServlet"), any(MetricsServlet::class.java))
        verify<MockServletContext>(servletContext).addFilter(eq("cachingHttpHeadersFilter"), any(CachingHttpHeadersFilter::class.java))
    }
    ...
    fun testStartUpDevServletContext() {
        ...
        verify<MockServletContext>(servletContext).addFilter(eq("webappMetricsFilter"), any(InstrumentedFilter::class.java))
        verify<MockServletContext>(servletContext).addServlet(eq("metricsServlet"), any(MetricsServlet::class.java))
        verify<MockServletContext>(servletContext, never()).addFilter(eq("cachingHttpHeadersFilter"), any(CachingHttpHeadersFilter::class.java))
    }
