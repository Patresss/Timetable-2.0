...
import com.patres.timetable.repository.search.UserSearchRepository;
...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder("ROLE_SCHOOL_ADMIN", "ROLE_ADMIN")));
    }
    ...
    public void testUserDTOtoUser() {
        UserDTO userDTO = new UserDTO(
            ...
            DEFAULT_LOGIN,
            null,
            Stream.of(AuthoritiesConstants.SCHOOL_ADMIN).collect(Collectors.toSet()));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.SCHOOL_ADMIN);
    }
    ...
    public void testUserToUserDTO() {
        ...
        authority.setName(AuthoritiesConstants.SCHOOL_ADMIN);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.SCHOOL_ADMIN);
    ...
    public void testAuthorityEquals() throws Exception {
        ...
        authorityA.setName(AuthoritiesConstants.SCHOOL_ADMIN);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.SCHOOL_ADMIN);
        assertThat(authorityA).isEqualTo(authorityB);
