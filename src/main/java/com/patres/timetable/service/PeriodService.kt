...
@Service
@Transactional
open class PeriodService(entityRepository: PeriodRepository, entityMapper: EntityMapper<Period, PeriodDTO>) : DivisionOwnerService<Period, PeriodDTO, PeriodRepository>(entityRepository, entityMapper)
