...
public class TimetableResource {
    ...
    /**
     * SEARCH  /_search/timetables?query=:query : search for the timetable corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<TimetableDTO>> searchTimetables(@RequestParam String query, @ApiParam Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/timetables");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
