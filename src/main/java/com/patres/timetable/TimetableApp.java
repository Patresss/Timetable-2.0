...
public class TimetableApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TimetableApp.class);

    private final Environment env;

    public TimetableApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TimetableApp.class);
