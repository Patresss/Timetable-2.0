...
@RestController
@RequestMapping("/api")
open class ProfileInfoResource(private val env: Environment, private val jHipsterProperties: JHipsterProperties) {

    @GetMapping("/profile-info")
    open fun getActiveProfiles(): ProfileInfoVM {
    ...
    inner class ProfileInfoVM(
        val activeProfiles: Array<String>,
        val ribbonEnv: String?
    )
}
