import {Component, ContentChild, ElementRef, EventEmitter, forwardRef, Input, NgModule, OnChanges, OnInit, Output, SimpleChanges, ViewChild} from '@angular/core';
...
import {Badge, Item, TemplateRenderer} from './menu-item';
